...
public class ClientHandler implements Runnable {
                ...
                if (handler.clientUsername.equals(this.clientUsername)) {
                    try {
                        this.objectOutputStream
                                .writeObject(new Message("Username already exists!\nEnter your username: ", "SERVER"));
            ...
            if (user != null) {
                ...
                try {
                    this.objectOutputStream.writeObject(
                            new Message("User, \"" + messageToSend.to() + "\", does not exist.", "SERVER"));
                    this.objectOutputStream.flush();
                } catch (IOException e) {
                    closeEverything();
                }
    ...
    public void removeClientHandler() {
        ...
        System.out.println("Client " + socket.getLocalAddress().getHostAddress() + " Disconnected!");
    }
